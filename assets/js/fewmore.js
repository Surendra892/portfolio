$(function () {
  ...
  var productimg = [
    "../Images/leeboot.jpg",
    "../Images/nikecasuals.webp",
    "../Images/levis.webp",
    "../Images/paragon.jpg",
    "../Images/sparks.webp",
    "../Images/woodland.webp",
    "../Images/samsung.webp",
    "../Images/realme fone.webp",
    "../Images/redmi.png",
    "../Images/oneplus.webp",
    "../Images/dell.jpg",
    "../Images/hp.jpg",
    ...
    "../Images/saries.jpg",
    "https://content3.jdmagicbox.com/comp/chennai/u2/044pxx44.xx44.150211152923.c4u2/catalogue/garden-chudidhar-park-chennai-7srojzdfvg.jpg",
    ...
    if (username == undefined) {
      ...
      if (hrs < 12) {
        ...
        document.getElementById(
          "salute"
        ).innerHTML = `Hello! ${username} Good Morning`;
      } else if (hrs >= 12 && hrs <= 17) {
        document.getElementById("icon").className = "bi bi-sun-fill";
        document.getElementById(
          "salute"
        ).innerHTML = `Hello! ${username} Good AfterNoon`;
      } else if (hrs > 17 && hrs <= 23) {
        document.getElementById("icon").className = "bi bi-sun-set";
        document.getElementById(
          "salute"
        ).innerHTML = `Hello! ${username} Good Evening`;
      }
    }
  }
  function LoadDate() {
  ...
  /**---------------Mouse Event Starts-------------------------*/
  redColor = () =>
    (document.getElementById("msg").innerHTML = `Sample Text`.fontcolor("red"));
  blueColor = () =>
    (document.getElementById("msg").innerHTML = "Sample Text".fontcolor(
      "blue"
    ));
  greenColor = () =>
    (document.getElementById("msg").innerHTML = `Sample Text`.fontcolor(
